...
const CreatePost = () => {
    ...
    const generateImage = async () => {
        if (form.prompt) {
            try {
                ...
                const response = await fetch("http://localhost:8080/api/v1/wcs", {
                    method: "POST",
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.prompt && form.photo) {
            ...
            alert("Please insert a prompt and generate an image");
        }
    };
  ...
  return (
    <section className="max-w-7xl mx-auto">
        ...
        <form className="mt-16 max-w-3xl" onSubmit={handleSubmit} >
            ...
            <div className="mt-5 relative bg-gray-50 border 
            ...
            <div className="mt-10">
                <p className="mt-2 text-[#666e75] text-[14px]">
                    Sharing your image with others in the Community
                </p>
                <button
                    type="submit"
